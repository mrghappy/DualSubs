...
const $ = new Env("🍿️ DualSubs v0.5.10-youtube-timedtext-response-mrg");
const URL = new URLs();
const XML = new XMLs();
...
const DataBase = {
	...
	"Default": {
		"Settings":{"Switch":true,"Types":["Official","Google","GoogleCloud","Azure","DeepL"],"Type":"Google","Languages":["ZH-HANT","EN"],"Language":"ZH-HANT","Translate":{"ShowOnly":false},"External":{"URL":null,"Offset":0,"ShowOnly":false},"Position":"Forward","CacheSize":6,"Tolerance":1000},
		"Configs": {
